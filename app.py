...
with st.sidebar:
    ...
    connect_btn = st.button("Connect / Refresh", use_container_width=True)
...
st.caption("Deployed for Databricks Apps. Uses Unity Catalog information_schema for metadata and SQL DDL for changes.")